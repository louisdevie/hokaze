...
import { JsonRefMapper, ObjectMapper, ValueMapper } from '@module/mappers/json'
import { Ref, Referenceable } from '@module/reference'
...
export interface ReferenceableValue<T> extends Referenceable<T> {
...
export class RefValue<R, N> extends AnyValue<Ref<R> | N, RefValue<R, N>> {
  private readonly _resource: ReferenceableValue<R>
  private readonly _serializeAs: RefSerializationForm
  private readonly _loading: RefLoadingStrategy

  public constructor(resource: ReferenceableValue<R>, copyFrom?: RefValue<R, N>, options?: RefValueOpts<R, N>) {
